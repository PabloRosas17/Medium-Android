 ...
 * @purpose, TabsView will display two tab capable fragments.
 */

/**
 * @desc TabsView servers as the host for two fragments.
 */
class TabsView : AppCompatActivity() ,
    BinderIf<LayoutTabsViewBinding> {

    /**
     * factory for [TabsViewModelFactory]
     */
    private val factory: ViewModelProvider.Factory = TabsViewModelFactory()


    /**
     * view model for [TabsViewModel]
     */
